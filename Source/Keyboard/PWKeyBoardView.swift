...
class PWKeyBoardView: UIView,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource {
    ...
    func setUI() {
        ...
        listModel =  KeyboardEngine.generateLayout(inputIndex: 0, presetNumber: "", numberType:numType,isMoreType:false);
    ...
    func updateText(text: String, isMoreType: Bool, inputIndex: Int){
        ...
        listModel = KeyboardEngine.generateLayout(inputIndex: inputIndex, presetNumber: text, numberType: numType,isMoreType:isMoreType);
        collectionView.reloadData()
    }
